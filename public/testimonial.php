  ...
  <a href="https://api.whatsapp.com/send?phone=+6285242673019&amp;text=Halo saya mau bertanya tentang Rupa Raya Academy" class="float" target="_blank">
    ...
    <nav id="nav" class="w-full top-0 z-[999] py-4 px-5 lg:px-12 bg-white shadow-2xl">
      <div class="max-w-[1440px] mx-auto flex justify-between items-center">
        ...
        <div class="md:flex gap-10 hidden text-[#273F5A] text-[15px] font-semibold">
            ...
            <a href="./listing.html" class="dropbtn hover:text-[#5386C0] duration-300">Kursus/Kelas</a>
            <a href="./about.html" class="hover:text-[#5386C0] duration-300">Tentang Kami</a>
            <a href="./testimonial.html" class="text-[#5386C0]">Testimonial</a>
        </div>
    ...
    <header class="">
      <div class="lg:h-fit h-[50vh] relative overflow-hidden centered-xy">
          <img class="img-cover object-top -z-10" src="../assets/testimonial/bg-testi.png" alt="">
  ...
  <section class="mt-20 max-lg:mx-4">
    <div class="container-cs centered-x max-lg:flex-col">
        ...
        <div class="text-[15px] mx-4 flex-[65%] text-[#757575] max-lg:mx-0">
            <p class="mb-5">Lihat Cerita Mereka yang Udah Nyobain dan Merasakan Sendiri Program Ini dan Manfaat yang Mereka Dapatkan!</p>
        </div>
    </div>
</section>

    <section class="relative"> <img src="/public/assets/testimonial/bg-shapes.png" class="absolute w-[1440px] -z-20 mx-auto top-10 right-0 left-0" alt="">

    <section class="">

        <div class="flex flex-wrap mx-auto gap-10 mt-10 max-lg:gap-y-5 centered-xy">
            <div class="">
                <iframe width="315" height="560" 
                    src="https://www.youtube.com/embed/6LA1rjNtAKg?si=8nebffrEEA3Ja4ff" 
                ...
                <div class="bg-[#273F5A] py-2 rounded-b-2xl">
                    <p class="text-center text-white text-[15px] font-light">Mahasiswi KAIST Korea</p>
                </div>
            </div>
        ...
        <div class="flex flex-wrap gap-x-20 mt-10 max-lg:gap-y-5 max-lg:mt-5 centered-xy">
