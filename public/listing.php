        ...
        <div class="flex flex-wrap gap-4 items-stretch justify-center self-stretch mt-10 max-md:mt-10">
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScWQS2TQw8ZG3zEOZ57wRKU5pg-BVj5zT-NS4kae-MesmSRlg/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card 3D Architectural Rendering Offline -->
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSctbqpgJr0QnP4NropL9zOSJQyGtUUpJZ2o9c8xMdr5SY2ocg/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card Speaking Communication English Offline -->
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScF7Cyw5eU8TNZtHaftDjNqaKhY7BJMC2OuAlV3_1JSGiUl9A/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card 3D Modelling Product & Photoshoot Offline -->
            ...
            <div id="class-item online" class="flex overflow-hidden flex-col grow-0 my-auto bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSf7eRvbOBE8wqD_-4fTMwUsywTuw85mVwL851fhXzPkDVm57w/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card 3D Modelling Product & Photoshoot Online -->
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSdDmtSE378_bc4aOa3bpzp0-e0fchvffz0uoqFAA2Y9vVDVPw/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card ArcGIS and Geospatial Offline -->
            ...
            <div id="class-item online" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSewwpV0h6MohizdmB1W0mHJXTlVSiC7z2Wxl_VBYALp2hrdgQ/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card ArcGIS and Geospatial Online -->
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSdWtiudjGY7FkzOUxzIHUobPXVb9JUqWUHzN_HMGumr3Ve-qg/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card SketchUp 3D Modelling Offline -->
            ...
            <div id="class-item offline" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 items-center justify-between px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    <div class="flex flex-col font-bold">
                        <p class="text-2xl text-white">Rp. 699.000</p>
                    </div>
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLScjeqPgSSOUUw6M8SmVACmREDgPg8t99sXK_G1xJaEpfoh08Q/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card Fullstack Developer Offline -->
            ...
            <div id="class-item online" class="flex overflow-hidden flex-col grow-0 bg-white rounded-2xl shadow-2xl min-w-[300px] max-w-[340px] hover:-translate-y-1 duration-300">
                ...
                <div class="relative flex gap-5 justify-between items-center px-4 pt-2.5 pb-4 mt-5 rounded-none bg-[#5386C0]">
                    ...
                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSev7KTP9_QEA1-A7G8O6QG4qR0VyvUkbMRFTuc2bTfHsx4Qtg/viewform" target="_blank" class="btn-second self-start px-3 py-1 mt-2.5 text-base font-semibold leading-relaxed text-white whitespace-nowrap rounded-md border border-white border-solid">Daftar</a>
                    <div class="-bottom-80 -left-8 w-96 h-96 absolute z-50 bg-white opacity-10 rounded-full flex items-center justify-center"></div>
                </div>
            </div>
            <!-- Card Fullstack Web Developer Online -->
